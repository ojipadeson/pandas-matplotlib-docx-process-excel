...
def set_border(row, line):
    set_cell_border(
            table1.cell(row, line),
            top={"sz": 3, "val": "single", "color": "#C0D9D9", "space": "0"},
            bottom={"sz": 3, "val": "single", "color": "#C0D9D9", "space": "0"},
            left={"sz": 3, "val": "single", "color": "#C0D9D9", "space": "0"},
            right={"sz": 3, "val": "single", "color": "#C0D9D9", "space": "0"},
        )
...
def set_table_picture(row, line, read_path, height = 2.1):
...
def set_table_paragraph(row, line, paragraph):
    table1.cell(row, line).vertical_alignment = WD_CELL_VERTICAL_ALIGNMENT.BOTTOM
...
table1.rows[9].height=Cm(15)
'''
table1.cell(9, 0).vertical_alignment = WD_CELL_VERTICAL_ALIGNMENT.BOTTOM
...
#table1.rows[10].height=Cm(16)
table1.cell(10, 0).vertical_alignment = WD_CELL_VERTICAL_ALIGNMENT.BOTTOM
run = table1.cell(10, 0).paragraphs[0].add_run(' ' * 5 + '二、工业品价格')
run.font.name='宋体' 
run.font.size=Pt(18)
run.font._element.rPr.rFonts.set(qn('w:eastAsia'), u'宋体')
run.font.bold=1         
...
for i in range(1, 5):
    table1.rows[2 * i - 1].height=Cm(1.4)
    set_border(2 * i - 1, 0)
...
for i in range(5, 13):
    if i * 2 >= 20:
        table1.rows[2 * i + 2].height=Cm(1.4)
        set_border(2 * i + 2, 0)
        set_table_paragraph(2 * i + 2, 0, quota_list[i * 2 - 2])
        set_border(2 * i + 3, 0)
        set_table_picture(2 * i + 3, 0, folder_path + quota_list[2 * i - 2] + '.png', 2.1)
        set_border(2 * i + 2, 1)
        set_table_paragraph(2 * i + 2, 1, quota_list[i * 2 - 1])
        set_border(2 * i + 3, 1)
        set_table_picture(2 * i + 3, 1, folder_path + quota_list[2 * i - 1] + '.png', 2.1)
    else:
        table1.rows[2 * i + 1].height=Cm(1.4)
        set_border(2 * i + 1, 0)
        set_table_paragraph(2 * i + 1, 0, quota_list[i * 2 - 2])
        set_border(2 * i + 2, 0)
        set_table_picture(2 * i + 2, 0, folder_path + quota_list[2 * i - 2] + '.png', 2.1)
        set_border(2 * i + 1, 1)
        set_table_paragraph(2 * i + 1, 1, quota_list[i * 2 - 1])
        set_border(2 * i + 2, 1)
        set_table_picture(2 * i + 2, 1, folder_path + quota_list[2 * i - 1] + '.png', 2.1)
